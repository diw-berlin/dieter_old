...
$call gdxdump results.gdx symb=report_tech_hours format=csv header="type, RES share, EV share, Prosumer share, Technology, Hour, Country, Value" output=results/report_hourly.csv
