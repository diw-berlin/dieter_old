...
*** hier auch DH p2H berücksichtigen
$ontext
$offtext
        =E= (
...
con15e_hop(n,hop,h)..
         Q(n,hop,h) =L=  N_Tech(n,hop)
;

con15f_fuel_consumption_chp_bp(n,chp_bp,h)..
         FC(n,chp_bp,h) =E= (G_L(n,chp_bp,h) + Q(n,chp_bp,h))/eta_T(n,chp_bp)
;
