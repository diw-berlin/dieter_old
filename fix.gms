...
STO_IN_PRO2PRO.fx(n,res,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_IN_PRO2M.fx(n,res,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_IN_M2PRO.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_IN_M2M.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_OUT_PRO2PRO.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_OUT_PRO2M.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_OUT_M2PRO.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_OUT_M2M.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_L_PRO2PRO.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_L_PRO2M.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_L_M2PRO.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_L_M2M.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
N_STO_E_PRO.fx(n,sto)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
N_STO_P_PRO.fx(n,sto)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
STO_L_PRO.fx(n,sto,h)$((feat_node('prosumage',n) = 0 OR m_sto_pro_p(n,sto) = 0) and not hs_dh(sto) ) = 0 ;
